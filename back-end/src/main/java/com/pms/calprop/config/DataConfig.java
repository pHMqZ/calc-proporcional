...
public class DataConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (personRepository.count() == 0 && billRepository.count() == 0) {
            ...
            System.out.println("Seeder executado. Pessoas salvas: " + personRepository.count() + ", Contas salvas: " + billRepository.count());
        } else {
            System.out.println("Banco de dados ja populado. Pulando a execucao do Seeder.");
        }
    }
