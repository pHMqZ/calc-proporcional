        ...
        <section className="card">
            ...
            <div className="mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {calculations.map((calc) => (
                        <div key={calc.id}>
                            <div className="text-[#6b7280] text-sm font-medium mb-1">{calc.name}</div>
                            <div className="text-2xl font-bold">{BRL.format(calc.totalWithReserve)}</div>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {calculations.map((calc) => (
                        <div key={calc.id}>
                            <div className="text-[#6b7280] text-sm font-medium mb-1"><strong>{calc.name}</strong></div>
                            <div className="text-2xl font-bold text-[#16a34a]">{BRL.format(calc.remaining)}</div>
                        </div>
                    ))}
                </div>
            </div>
